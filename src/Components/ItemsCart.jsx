        ...
        <div className="flex justify-between">
          ...
          <div className="flex justify-center items-center gap-2 right-7 absolute">
            <AiOutlineMinus
              ...
              className="border-2 border-gray-600 text-gray-600 hover:text-white hover:bg-green-500 hover:border-none rounded-md p-1 text-xl transition-all cursor-pointer ease-linear"
            />
            <span>{qty}</span>
            <AiOutlinePlus
              onClick={() =>
